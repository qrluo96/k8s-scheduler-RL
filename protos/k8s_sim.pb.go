...
type ScheduleResult struct {
	SuggestHost          string   `protobuf:"bytes,1,opt,name=suggest_host,json=suggestHost,proto3" json:"suggest_host,omitempty"`
	EvaluatedNodes       int32    `protobuf:"varint,2,opt,name=evaluated_nodes,json=evaluatedNodes,proto3" json:"evaluated_nodes,omitempty"`
	FeasibleNodes        int32    `protobuf:"varint,3,opt,name=feasible_nodes,json=feasibleNodes,proto3" json:"feasible_nodes,omitempty"`
	ScheduleProcess      int32    `protobuf:"varint,4,opt,name=schedule_process,json=scheduleProcess,proto3" json:"schedule_process,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ScheduleResult) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ScheduleResult.Unmarshal(m, b)
}
...
func (m *ScheduleResult) XXX_Size() int {
	return xxx_messageInfo_ScheduleResult.Size(m)
}
...
func (m *ScheduleResult) GetSuggestHost() string {
	if m != nil {
		return m.SuggestHost
	}
	return ""
}

func (m *ScheduleResult) GetEvaluatedNodes() int32 {
	if m != nil {
		return m.EvaluatedNodes
	}
	return 0
}

func (m *ScheduleResult) GetFeasibleNodes() int32 {
	if m != nil {
		return m.FeasibleNodes
	}
	return 0
}

func (m *ScheduleResult) GetScheduleProcess() int32 {
	if m != nil {
		return m.ScheduleProcess
	}
	return 0
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_4c18405e8fba6db3, []int{8}
}
...
func init() {
	...
	proto.RegisterType((*ScheduleResult)(nil), "simRPC.ScheduleResult")
...
var fileDescriptor_4c18405e8fba6db3 = []byte{
	...
	,
}
...
type SimRPCClient interface {
	...
	RecordPodMetrics(ctx context.Context, in *PodMetrics, opts ...grpc.CallOption) (*Result, error)
	ListScheduleResult(ctx context.Context, in *PodMetrics, opts ...grpc.CallOption) (*ScheduleResult, error)
}
...
func (c *simRPCClient) RecordPodMetrics(ctx context.Context, in *PodMetrics, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *simRPCClient) ListScheduleResult(ctx context.Context, in *PodMetrics, opts ...grpc.CallOption) (*ScheduleResult, error) {
	out := new(ScheduleResult)
	err := c.cc.Invoke(ctx, "/simRPC.simRPC/ListScheduleResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimRPCServer interface {
	...
	RecordPodMetrics(context.Context, *PodMetrics) (*Result, error)
	ListScheduleResult(context.Context, *PodMetrics) (*ScheduleResult, error)
}
...
func (*UnimplementedSimRPCServer) RecordPodMetrics(ctx context.Context, req *PodMetrics) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecordPodMetrics not implemented")
}
func (*UnimplementedSimRPCServer) ListScheduleResult(ctx context.Context, req *PodMetrics) (*ScheduleResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListScheduleResult not implemented")
}
...
func _SimRPC_RecordPodMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimRPCServer).RecordPodMetrics(ctx, req.(*PodMetrics))
	}
	return interceptor(ctx, in, info, handler)
}

func _SimRPC_ListScheduleResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PodMetrics)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimRPCServer).ListScheduleResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simRPC.simRPC/ListScheduleResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimRPCServer).ListScheduleResult(ctx, req.(*PodMetrics))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SimRPC_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListScheduleResult",
			Handler:    _SimRPC_ListScheduleResult_Handler,
		},
	},
